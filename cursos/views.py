...
def curso(request, id):                                                #Acessar curso
    if request.session.get('usuario'):
...
def aula(request, id):                                                  #Acessar aula e avaliação da Aula    
    if request.session.get('usuario'):
...
def comentarios(request):                                             # Incluir e exibir comentarios
...
def processa_avaliacao(request):                                       #Incluir avaliação das Aulas
    if request.session.get('usuario'):
